...
public class DAOPlayer extends DAO<Player> {
    ...
    public Player find(int id) {
        ...
        Cursor c = db.query("Player", new String[]{"IdPlayer", "PseudoPlayer", "RacePlayer", "LevelPlayer", "StrongPlayer", "PerceptionPlayer", "EndurancePlayer", "CharismaPlayer", "IntelligencePlayer", "AgilityPlayer", "LuckPlayer", "ExpCurrPlayer"}, "IdPlayer=?", new String[]{String.valueOf(id)}, null, null, null);
        c.moveToFirst();
        Player player = new Player(c.getInt(0),c.getString(1),c.getString(2),c.getInt(3),c.getInt(4),c.getInt(5),c.getInt(6),c.getInt(7),c.getInt(8),c.getInt(9),c.getInt(10),c.getInt(11));
        return player;
    }
    ...
    public ArrayList<Player> findAll() {
        ...
        while(c.moveToNext()) {
            player = new Player(c.getInt(0), c.getString(1), c.getString(2), c.getInt(3), c.getInt(4), c.getInt(5), c.getInt(6), c.getInt(7), c.getInt(8), c.getInt(9), c.getInt(10),c.getInt(11));
